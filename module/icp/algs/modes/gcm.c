...
/*
 * FIXME: Do we need this? There was a bug were FPU regs leaked to
 * userspace and they hold sensitive internal crypto data. The performance
 * impact is measurable. TODO
 */
#define	clear_fpu_regs() clear_fpu_regs_avx()  // Don't leak internal state.
